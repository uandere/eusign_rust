...
// We'll firtst define some constants (matching original #defines)
...
///////////////////////////////////////////////////////////////////////////////
// The main() function, replicating usage example
///////////////////////////////////////////////////////////////////////////////
fn main() {
    unsafe {
        ...
        let free_sender_info = (*G_P_IFACE).FreeSenderInfo.unwrap();
        free_sign_info(&mut signInfo);
        free_sender_info(&mut senderInfo);
